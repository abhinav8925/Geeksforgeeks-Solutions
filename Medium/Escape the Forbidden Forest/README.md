<h2><a href="https://practice.geeksforgeeks.org/problems/escape-the-forbidden-forest--141631/1?page=1&difficulty[]=1&status[]=unsolved&category[]=Dynamic%20Programming&category[]=Tree&category[]=Hash&category[]=Graph&category[]=Greedy&sortBy=accuracy">Escape the Forbidden Forest</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Penelope and her classmates are lost in the Forbidden Forest and the Devil is out to get them. But Penelope has magical powers that can build bridges across the dangerous river and take her friends to safety. The only bridges that can withstand the Devil's wrath are the ones built between two similar trees in the forest.&nbsp;<br>
