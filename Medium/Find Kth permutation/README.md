<h2><a href="https://practice.geeksforgeeks.org/problems/find-kth-permutation-0932/1?page=1&difficulty[]=0&difficulty[]=1&status[]=unsolved&sortBy=latest">Find Kth permutation</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given two integers&nbsp;<strong>N&nbsp;</strong>(1&lt;=N&lt;=9) and&nbsp;<strong>K</strong>. Find the kth permutation sequence of first N natural numbers. Return the answer in&nbsp;<strong>string</strong>&nbsp;format.</span></p>
